...
import pytest
import glob
from whiskers.logging_config import setup_logging, get_logger, LoggingManager
...
def get_log_file_path():
    ...
    log_dir = os.path.join(repo_root_dir, "whiskers", "logs")
...
def test_setup_logging(cleanup_logger):
    ...
    try:
        ...
        assert logger == logging.getLogger('whiskers')
...
def test_timestamp_in_log_filename(cleanup_logger):
    ...
    try:
        ...
        # Fix: Account for the fact that "whiskers" contains an underscore
