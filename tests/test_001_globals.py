"""
This file contains tests for the global variables in the whiskers package.
Functions:
...
from whiskers import apilevel, threadsafety, paramstyle, lowercase, getDecimalSeparator, setDecimalSeparator
...
def test_lowercase_thread_safety_no_db():
    """
    Tests concurrent modifications to whiskers.lowercase without database interaction.
    ...
    assert whiskers.lowercase is False, "Final state of lowercase should be False"
